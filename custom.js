    ...
    Core.initialize();
		...
		$('#home > section.header-section.home-header > div.scroll-down').on('click',function () {
          ...
          $('body, html').animate({ scrollTop: 700 }, 800);
               ...
               var $urungorseli1 = $('#urungorselleri > div:nth-child(2) > section > div > figure > img');
               
		
		$("#urungorselleri > div:nth-child(2) > section > div > figure > img").on('click', function(event) { 
...
$("#urungorselleri > div:nth-child(2) > section > div > figure > figure > img").on('click', function(event) { 
			event.preventDefault(); 
			$("#basildin2").click(); 
			});
